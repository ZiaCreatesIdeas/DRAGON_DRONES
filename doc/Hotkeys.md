...
| Proportional Grab | O + G + Click [Vertice, Edge, Face ] + MMB - Scroll Up |[Video (Tutorial 2)](Hardware.md#proportional-editing) |
|Scale Along Normals | Alt + S | [Video (Tutorial 2)](Hardware.md#scale-along-normals) |  
| Extrude | E | ![Extrude](./Images/Hot_Keys/Hot-Key_E-Extrude.gif)|
| Select Edge Loop | Alt + LMB | [Part 04: Select Edges](Hardware.md#select-edges)|
